...
**Q1**
How did support for Maryland politicians depend on demographics? This could be done with American Community Survey demographic data and breakdowns from this table that described votes for specific candidates. 

**Q2**
Which counties in Maryland had the highest support for certain candidates? Based on American Community Survey data, did lower area counties (and cities in counties) tend to vote for one candidate in particular?
