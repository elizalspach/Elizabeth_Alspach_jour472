...
#48.5% of 
```{r}
below_median_percent <- (97/200)*100 %>% 
  View(below_median_percent)
...
Nearly half of incomes in neighborhoods in Baltimore City are below the median line, according to an analysis from Baltimore City income data. Read more at [link].
