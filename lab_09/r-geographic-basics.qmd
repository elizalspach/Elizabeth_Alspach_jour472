...
Question 1: How does median income correspond to English language fluency? Are the two factors related? You could use English language literacy rate dataframes as well as median income data to map this, and discover which areas have both the highest fluency and median income. From there, could understand how the two factors correspond and if there are any areas in Maryland that reflect this trend? Census data may be able to provide this as well.

Question 2: What areas of Maryland have the highest rates of positive COVID-19 cases? This would be interactive and correspond with the population of an area, and could use CDC and Census dataframes. With this, you could understand what areas of Maryland really face the worst COVID-19 positivity rate when weighted for their total populations. 
