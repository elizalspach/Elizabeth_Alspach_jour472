...
#make this all the same color sigh
```{r results='asis'}
...
md_traffic_clean <- md_traffic %>% 
  ...
  filter(functional_class == "Interstate" | county_name == "Baltimore")

#lol why isn't filter for baltimore working here
```
...
interstate_balt <- md_traffic_clean %>% 
  mutate(aadt_pct_change = ((aadt_current-aadt_2013)/aadt_2013)*100) %>% 
  mutate(aawdt_pct_change = ((aawdt_current-aawdt_2013)/aawdt_2013)*100) %>% 
  select(county_name, aadt_2013, aadt_2014, aadt_2015, aadt_2016, aadt_2017, aadt_current, aadt_pct_change, aawdt_2013, aawdt_2014, aawdt_2015, aawdt_2016, aawdt_2017, aawdt_2018, aawdt_current, aawdt_pct_change)
