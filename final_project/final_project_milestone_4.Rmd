...
First, I wanted to understand the demographics of both Carroll and Howard counties and how that has changed over time. For this, I took U.S. Census Data from 2020 and 2010 to see how these populations have changed. With the rising cost of living as well, I would like to see how the diversity of these counties have changed and if they have changed because of living costs. **Q**
...
```{r}
#joining dataframes, mutating to make new columns
...
x2021_business_patterns <- rio:::import("cbp21co.txt")

x2020_business_patterns <- rio:::import("cbp20co.txt")
